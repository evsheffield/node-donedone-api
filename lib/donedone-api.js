 ...
 * @param  {Function} callback           Callback function with two arguments `(err, data)`
 */
exports.getProject = function(subdomain, username, passwordOrAPIToken, id, callback) {
  apiCall(subdomain, username, passwordOrAPIToken, 'projects/' + id + '.json', 'GET', callback);
};
...
exports.getIssue = function(subdomain, username, passwordOrAPIToken, projectId, issueId, callback) {
  apiCall(subdomain, username, passwordOrAPIToken, 'projects/' + projectId + '/issues/' + issueId + ".json", 'GET', callback);
};
 ...
 *
 * The email body has limited templating capabilities. Put any of the following in the email
 * body and it will be replaced with its corresponding value.
